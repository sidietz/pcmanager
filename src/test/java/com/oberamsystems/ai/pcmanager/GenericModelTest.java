...
public class GenericModelTest {
        ...
        public void testAllModels() throws Exception {
                File folder = new File("src/main/java/com/oberamsystems/ai/pcmanager/model");
                ...
                for (File file : files) {
                        if (file.isFile() && file.getName().endsWith(".java")) {
                                String className = "com.oberamsystems.ai.pcmanager.model."
                                ...
                                try {
                                        ...
                                        for (Constructor<?> constructor : constructors) {
                                                ...
                                                for (int i = 0; i < paramTypes.length; i++) {
                                                        ...
                                                        if (dummy == null && !paramTypes[i].isPrimitive()
                                        ...
                                        for (Method method : methods) {
                                                if (method.getName().startsWith("set")
                                                        ...
                                                        if (dummyValue == null && !paramType.isPrimitive()
                                                                        && !paramType.isArray()
